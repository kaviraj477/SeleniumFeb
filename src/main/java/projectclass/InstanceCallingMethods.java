...
public class InstanceCallingMethods {                          // two types of variable = 1.intsance & 2.Static
	                                           //instance variable
	...
	static InstanceCallingMethods svobject = null;
	...
	public static void main (String [] args) { //we can call methods without creating object because of static
		...
		InstanceCallingMethods objectinstance = new InstanceCallingMethods();          // creating object for instance variable
		System.out.println(objectinstance.instance3);  //calling instance varaiable value (objectname.variablename)
		 
		System.out.println(InstanceCallingMethods.instance4);          // calling static variable (classname.variablename)
	    ...
	    InstanceCallingMethods object =  new InstanceCallingMethods(); //calling method for non static type (ojectname.methodname)
